...
class DriverLoginActivity : AppCompatActivity() {
    ...
    private fun initialise() {
        ...
        tvForgot!!
                .setOnClickListener { startActivity(Intent(this@DriverLoginActivity,
                        ForgotPasswordActivity::class.java)) }

        btnCreate!!.setOnClickListener{ startActivity(Intent(this@DriverLoginActivity, DriverCreateAccountActivity::class.java) )}
            ...
            mAuth!!.signInWithEmailAndPassword(email!!, password!!)
                    .addOnCompleteListener(this) { task ->
                        ...
                        if (task.isSuccessful) {
                            ...
                            Toast.makeText(this@DriverLoginActivity, "Authentication failed.",
